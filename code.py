...
print('1 - média total | 2 média aluno | 3 - moda mediana amplitude | 4 - maior média')
escolha = input('digite oque deseja visualizar>>')
...
if escolha == '1':
    ...
    print("MÉDIA ALUNOS: ")
    print("Ana: ", media_ana)
    print('Fernanada: ', round(media_fernanda, 2))
    print('media leo: ', media_leo)
elif escolha == '3':
    ...
    print('moda Leo', moda_fernanda)
elif escolha == '4':
    print(f'MAIOR NOTA ANA - {maior_nota_ana}\nMAIOR NOTA FERNANDA - {maior_nota_fernanda}\nMAIOR NOTA LEO - {maior_nota_leo} ' )
else:
    print('digie algo válido')
